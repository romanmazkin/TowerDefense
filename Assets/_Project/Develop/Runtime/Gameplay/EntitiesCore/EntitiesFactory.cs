...
namespace Assets._Project.Develop.Runtime.Gameplay.EntitiesCore
{
    public class EntitiesFactory
    {
        ...
        private CollidersRegisteryService _colidersRegisteryService;
            ...
            CollidersRegisteryService collidersRegisteryService)
        {
            ...
            _colidersRegisteryService = collidersRegisteryService;
        }
        ...
        public Entity CreateSkeleton(Vector3 position, SkeletonConfig config)
        {
            Entity entity = CreateEmpty();
            ...
            entity
                ...
                .AddSystem(new BodyContactsEntitiesFilterSystem(_colidersRegisteryService))
